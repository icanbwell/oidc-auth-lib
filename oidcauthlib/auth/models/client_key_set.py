...
class ClientKeySet(BaseModel):
    ...
    well_known_config: dict[str, Any] | None = Field(description="OIDC well-known configuration document")
    kids: list[str] | None = Field(description="List of Key IDs (kid) available in the JWKS")
